    ...
    <div class="footer-grid">
        <div id="footer-brand" class="footer-col">
            <div class="footer-brand-row">
                <div class="logo-bg">
                    <i class="logo-icon" data-fa-i2svg="">
                        <svg class="svg-inline--fa fa-headset" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="headset" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                ...
                <span class="footer-title">Docsy</span>
            </div>
            <p class="footer-desc">Your go-to resource for getting the most out of our platform.</p>
        </div>
        
        <div id="footer-support" class="footer-col">
            <h3 class="footer-heading">Support</h3>
            <ul class="footer-list">
                <li><span class="footer-link">Help Center</span></li>
                <li><span class="footer-link">Contact Us</span></li>
                <li><span class="footer-link">Submit Ticket</span></li>
                <li><span class="footer-link">Status Page</span></li>
            </ul>
        </div>
        
        <div id="footer-resources" class="footer-col">
            <h3 class="footer-heading">Resources</h3>
            <ul class="footer-list">
                <li><span class="footer-link">Documentation</span></li>
                <li><span class="footer-link">API Reference</span></li>
                <li><span class="footer-link">Video Tutorials</span></li>
                <li><span class="footer-link">Community</span></li>
            </ul>
        </div>
        
        <div id="footer-company" class="footer-col">
            <h3 class="footer-heading">Company</h3>
            <ul class="footer-list">
                <li><span class="footer-link">About Us</span></li>
                <li><span class="footer-link">Privacy Policy</span></li>
                <li><span class="footer-link">Terms of Service</span></li>
                <li><span class="footer-link">Security</span></li>
            </ul>
        </div>
    </div>
    
    <div class="footer-bottom">
        <p class="footer-copyright">© 2024 Help Center. All rights reserved.</p>
