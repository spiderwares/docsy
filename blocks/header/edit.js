...
import { PanelBody, ToggleControl, Button, TextControl, SelectControl, Notice } from '@wordpress/components';
...
export default function Edit({ attributes, setAttributes }) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody title={__('Header Settings', 'docsy')}>
					<ToggleControl
				...
				<PanelBody title={__('Navigation Menu', 'docsy')} initialOpen={true}>
					{!menus && (
